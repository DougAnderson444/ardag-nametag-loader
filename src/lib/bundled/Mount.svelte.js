...
const g = [], L = [], E = [], B = [], z = Promise.resolve();
let O = !1;
function R(t) {
  E.push(t);
}
...
function S() {
  ...
  do {
    ...
    for (b(null), g.length = 0, v = 0; L.length; )
      L.pop()();
...
function H(t, n) {
  t.$$.dirty[0] === -1 && (g.push(t), O || (O = !0, z.then(S)), t.$$.dirty.fill(0)), t.$$.dirty[n / 31 | 0] |= 1 << n % 31;
}
function T(t, n, o, r, u, p, f, _ = [-1]) {
  ...
  if (e.ctx = o ? o(t, n.props || {}, (c, a, ...i) => {
    ...
    n.intro && (l = t.$$.fragment) && l.i && (F.delete(l), l.i(void 0)), function(c, a, i, d) {
      ...
      x && x.m(a, i), d || R(() => {
        const m = c.$$.on_mount.map(M).filter(N);
        c.$$.on_destroy ? c.$$.on_destroy.push(...m) : k(m), c.$$.on_mount = [];
      }), w.forEach(R);
...
function I(t, n, o) {
    ...
    return (e, $, { cancelable: l = !1 } = {}) => {
      ...
      if (c) {
        const a = function(i, d, { bubbles: x = !1, cancelable: w = !1 } = {}) {
          const m = document.createEvent("CustomEvent");
          return m.initCustomEvent(i, x, w, d), m;
        }(e, $, { cancelable: l });
  ...
  return _ = async () => {
    u && async function({ text: s, target: e, props: $ }) {
      ...
      c && URL.revokeObjectURL(c), f("ready", a), f("target", e), i.$on("change", (d) => {
        f("change", d);
      });
